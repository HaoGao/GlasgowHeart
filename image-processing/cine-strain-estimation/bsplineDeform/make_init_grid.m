...
if(length(Spacing)==2) %If the length of vector/largest array dimension
                       %is equal (or element by element comparision) to 
                       %value of 2 then:
...
%%%%%%%%%%%%%%%%%%IGNORE REST%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if(exist('M','var')), %Checks existence of variable 'M' and 'var'
