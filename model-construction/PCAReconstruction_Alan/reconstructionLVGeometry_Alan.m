function reconstructionLVGeometry_Alan(reconstructed_method, abaqusDir_pca, abaqusDir_preMesh, ...
...
disp('preparing LV mesh begins .......');
 if reconstructed_method == 1
               ...
               pcaReconstructionUsing4EigenVectors(wc_pca, options.pcaResult.LV_mean,...
                        options.pcaResult.eigVecs,options.pcaResult.pop_mean,options.pcaResult.pop_sd, abaqusDir_pca,abaqusDir_preMesh, outputB);
