...
elseif isunix 
    abaqusDir = sprintf('/xlwork3/hgao/Alan_Simulator/AbaqusWorkingSpace/%s_test',subject_name);
end
...
elseif isunix
    abaqusDir_preMesh = sprintf('/xlwork3/hgao/segmentationResults/Results_original/%s/earlyDiastole', subject_name);
